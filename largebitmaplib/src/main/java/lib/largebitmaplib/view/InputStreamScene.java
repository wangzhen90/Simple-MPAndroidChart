package lib.largebitmaplib.view;
...
public class InputStreamScene extends Scene {
    ...
    public InputStreamScene(InputStream inputStream) throws IOException {
        ...
        //TODO https://github.com/johnnylambada/WorldMap/issues/9#issuecomment-303200477
...
//        tmpOptions.inSampleSize = (1<< 3);
        //TODO https://blog.csdn.net/maxwell_nc/article/details/49081105
        //先设置为true，在设置为false，如果不reset会出现decodeStream返回空的情况，因为流不是从起始位置解析的
        inputStream.reset();
